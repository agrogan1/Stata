...
You can create new variables (e.g. scales) out of old variables using `generate newvar = expression` e.g. `generate newvar = oldvar1 + oldvar2 + oldvar3` will create a scale out of these three variables.[^alpha]

[^alpha]: `alpha oldvar1 oldvar2 oldvar3` will calculate Cronbach's alpha from this scale.
