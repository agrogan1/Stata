...
I have written a [Stata Michigan graph scheme](https://agrogan1.github.io/Stata/) that can be installed. Asjad Naqvi has written [an excellent and comprehensive set of Stata graph schemes](https://github.com/asjadnaqvi/Stata-schemes), including the `neon` scheme used in some examples in this tutorial.
