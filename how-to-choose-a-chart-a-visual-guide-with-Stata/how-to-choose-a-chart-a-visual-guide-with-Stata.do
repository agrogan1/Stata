...
"I try to present the simplest version of a command, but to make this handout occasionally makes use of options like {stMono:fcolor(%50)} and {stMono:mcolor(%50)} " ///
"to tweak the color transparency." ///
